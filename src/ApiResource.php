...
abstract class ApiResource
{
    ...
    protected static function _scopedRetrieve($class, $id)
    {
        ...
        $response = ApiRequestor::request('get', $url);
    ...
    protected static function _scopedLogin($class, $params)
    {
        ...
        $response = ApiRequestor::request('post', $url, $params);
...
//      $class = strtolower($class);
        ...
        if ($class == User::class) {
            return "/users";
        } else if ($class == Course::class) {
            return "/courses";
        } else if ($class == Category::class) {
            return "/categories";
        } else if ($class == Branch::class) {
            return "/branches";
        } else if ($class == Group::class) {
            return "/groups";
        } else if ($class == Siteinfo::class) {
            return "/siteinfo";
        }
    }
